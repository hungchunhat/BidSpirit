                ...
                <div class="col-md-8">
                    ...
                    @can('admin')
                        <div class="mb-4">
                            ...
                            <button class="btn btn-outline-primary" form="change-auction">Change Detail</button>
                        </div>
                        <form id="start-auction" method="post" action="{{route('auction.start',$auction->id)}}" style="display: none">
                            @csrf
                            @method('PATCH')
                        </form>
                        <form id="change-auction" action="{{route('auction.edit',$auction->id)}}" style="display: none" method="get">
                        </form>
                    @endcan
                </div>
