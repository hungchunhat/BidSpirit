<x-layout>
        ...
        <div class="container">
                        ...
                        <table class="table table-hover text-center">
                            ...
                            @foreach($feedbacks as $feedback)
                                <tr id="feedback{{$feedback->id}}">
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#deleteFModal" data-bs-id="{{ $feedback->id }}">Delete
                                        </button>
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="deleteModalLabel">Notification</h1>
            ...
            <!-- Modal Delete User -->
            <div class="modal fade" id="deleteUModal" tabindex="-1" aria-labelledby="deleteUModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="deleteUModalLabel">Notification</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
            ...
            <!-- Modal Change Role -->
            <div class="modal fade" id="changeUModal" tabindex="-1" aria-labelledby="changeUModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="changeUModalLabel">Notification</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-warning" id="confirmChange">Change</button>
                        </div>
                    </div>
                </div>
            </div>
            <!-- Modal Delete Auction -->
            <div class="modal fade" id="deleteAModal" tabindex="-1" aria-labelledby="deleteUModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <!-- Modal Product -->
            <div class="modal fade" id="deleteFModal" tabindex="-1" aria-labelledby="deleteFModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="deleteFModalLabel">Notification</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-danger" id="confirmFDelete">Delete</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <x-slot:script>
        ...
        <script type="module">
            let id = null;
            let deleteF = document.getElementById('deleteFModal');
            let deleteFBtn = document.getElementById('confirmFDelete');
            let closeBtn = deleteF.querySelector('.btn-close');
            deleteF.addEventListener('show.bs.modal', function (event) {
                let button = event.relatedTarget;
                id = button.getAttribute('data-bs-id');
                console.log(id);
                deleteFBtn.disabled = false;
            })
            deleteFBtn.addEventListener('click', function () {
                deleteFBtn.disabled = true;
                let data = {
                    id: id,
                }
                axios.delete('{{route('feedback.destroy')}}', {data})
                    .then(function (response) {
                        console.log(response);
                        let row = document.getElementById('feedback' + id);
                        row.remove();
                        closeBtn.click();
                    }).catch(function (error) {
